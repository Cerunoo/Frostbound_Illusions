...
public partial class @InputSettings: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSettings()
    {
        ...
        UnityEngine.Debug.Assert(!m_InteractionButton.enabled, "This will cause a leak and performance issues, InputSettings.InteractionButton.Disable() has not been called.");
